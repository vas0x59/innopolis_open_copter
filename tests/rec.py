...
navigate_wait(x=start_coord[0], y=start_coord[1]+1, z=z+1, speed=0.5, frame_id="aruco_map")

navigate_wait(x=start_coord[0], y=start_coord[1]+1, z=z, speed=0.5, frame_id="aruco_map")
