...
navigate_wait(x=1.5, y=1.5, z=z, speed=0.5, frame_id="aruco_map")
navigate_wait(x=1.5, y=1.5, z=z+1, speed=0.5, frame_id="aruco_map")
navigate_wait(x=1.5, y=1.5+1, z=z+1, speed=0.5, frame_id="aruco_map")
navigate_wait(x=1.5, y=1.5+1, z=z, speed=0.5, frame_id="aruco_map")
navigate_wait(x=1.5, y=1.5, z=z, speed=0.5, frame_id="aruco_map")
