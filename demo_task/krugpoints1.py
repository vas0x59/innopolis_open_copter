...
def navigate_wait(x=0, y=0, z=0, speed=0, frame_id='aruco_map', auto_arm=False, tolerance=0.325, yaw=float('nan')):
...
for i in points:
	navigate_wait(x=i[0], y=i[1], z=z, speed=0.6, frame_id="aruco_map",yaw=round(i[2],2))
